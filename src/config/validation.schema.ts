...
export const validationSchema = Joi.object({
  ...
  CACHE_COMPRESSION_ENABLED: Joi.string()
    .valid('true', 'false')
    .default('false'),
  CACHE_COMPRESSION_THRESHOLD: Joi.number().default(1024),
  CACHE_SERIALIZATION_TYPE: Joi.string()
    .valid('json', 'msgpack')
    .default('json'),
  ...
  CACHE_SCHEDULED_CLEANUP_ENABLED: Joi.string()
    .valid('true', 'false')
    .default('false'),
  CACHE_CLEANUP_INTERVAL: Joi.string().default('0 0 * * *'),
  CACHE_MEMORY_CLEANUP_ENABLED: Joi.string()
    .valid('true', 'false')
    .default('false'),
  ...
  // 队列监控配置
  QUEUE_MONITORING_ENABLED: Joi.string()
    .valid('true', 'false')
    .default('false'),
  ...
  QUEUE_BACKOFF_TYPE: Joi.string()
    .valid('exponential', 'fixed')
    .default('exponential'),
  ...
  GRACEFUL_SHUTDOWN_ENABLED: Joi.string()
    .valid('true', 'false')
    .default('false'),
  ...
  APM_CAPTURE_BODY: Joi.string()
    .valid('off', 'errors', 'transactions', 'all')
    .default('errors'),
  APM_CAPTURE_HEADERS: Joi.string().valid('true', 'false').default('false'),
  APM_LOG_LEVEL: Joi.string()
    .valid('trace', 'debug', 'info', 'warn', 'error', 'fatal')
    .default('info'),

  // 错误监控配置 (Sentry)
  ERROR_MONITORING_ENABLED: Joi.string()
    .valid('true', 'false')
    .default('false'),
  ...
  SENTRY_CONSOLE_INTEGRATION: Joi.string()
    .valid('true', 'false')
    .default('false'),
  SENTRY_MODULES_INTEGRATION: Joi.string()
    .valid('true', 'false')
    .default('false'),
  ...
  TRACING_SAMPLER_TYPE: Joi.string()
  ...
  ALERT_HIGH_RESPONSE_TIME: Joi.string()
    .valid('true', 'false')
    .default('false'),
